        ...
        <div className="mx-auto grid max-w-7xl items-center gap-16 lg:grid-cols-2">
          <div className="relative animate-flicker">
            ...
            <h1 className="mb-8 text-5xl leading-[1.02] font-bold tracking-tighter text-balance md:text-7xl lg:text-[5.5rem]">
              MAKE YOUR PHONE A <span className="text-primary">PRIVATE</span> PHOTOBOOTH.
            </h1>
            <p className="mb-10 max-w-md font-mono text-base text-foreground/60">
              Turn any screen into a professional capture station. Instant prints, branded frames, pure arcade energy — for any personal, business and social activities, schools, parties, weddings, and brand events.
            </p>
            <div className="flex flex-wrap gap-4">
              <Link to="/frame">
                <NeonButton size="lg" glow>Start Free Demo</NeonButton>
              </Link>
            </div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              },
              {
                ...
                desc: "Print up to 5R at any printing booth. Pay per print. No subscription.",
                img: servicePrint,
              ...
              },
              {
                ...
                desc: "Create your own frame, let any guest snap from their own phone, and share or print on the spot. One QR code turns the whole room into your photo crew.",
                img: kioskUnit,
